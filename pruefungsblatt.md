...
2.1 Katalog als Typenliste (intern). Zu Beginn jedes Baus holst du den Katalog in einem Aufruf:
    ...
    B=https://raw.githubusercontent.com/hz-0801/mathe-nachhilfe/main/msa; for f in msa-typen.csv msa-katalog-basis.csv msa-katalog-kontext.csv; do curl -sS -o $f $B/$f; done
